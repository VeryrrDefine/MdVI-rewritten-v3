...
<template>
    ...
    <button class="PL1button" @click="PL1reset()">
        3维体积重置: 
        <span v-if="player.volumes.lt(1.157920892373162e+77)">需要{{ format(1.157920892373162e+77) }}mm<sup>4</sup>4维体积</span>
    ...
    <div class="text-center">
        ...
        <button @click="switchpage(4)" :disabled="tabshow.mm3.inTab()" v-if="tabshow.mm3.unlocked()" class="btn mm3">3维体积</button>
